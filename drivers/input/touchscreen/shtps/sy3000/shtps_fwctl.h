...
typedef int (*fwctl_if_get_gesturetype_t)(struct shtps_fwctl_info *, u8 *, u8 *);
...
#define shtps_fwctl_get_gesturetype(ts, status, property)							ts->fwctl_p->fwctl_func_p->get_gesturetype_f(ts->fwctl_p, status, property)
